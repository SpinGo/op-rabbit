...
public class Host {
    ...
    public static String pathToRabbitMqCtl = com.typesafe.config.ConfigFactory.load().getString("rabbitmqctl-path");
    ...
    public static Process rabbitmqctl(String command) throws IOException {
        return executeCommand(pathToRabbitMqCtl + " " + command);
    }

    public static Process rabbitmqctlIgnoreErrors(String command) throws IOException {
        return executeCommandIgnoringErrors(pathToRabbitMqCtl + " " + command);
    }
