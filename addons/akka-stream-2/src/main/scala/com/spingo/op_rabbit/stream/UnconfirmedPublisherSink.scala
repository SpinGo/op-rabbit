...
object UnconfirmedPublisherSink {
  ...
  def apply[T](rabbitControl: ActorRef, messageFactory: MessageForPublicationLike.Factory[T, UnconfirmedMessage], timeoutAfter: FiniteDuration = 30 seconds, qos: Int = 8): Sink[T, Future[Unit]] = {
